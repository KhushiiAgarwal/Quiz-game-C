...
int main(){
    ...
    printf("\n\t\t______________");
    printf("\n\t\t______________");
    printf("\n\t\t > Press S for SPORTS QUIZ EASY");
    printf("\n\t\t > Press M for SPORTS QUIZ MEDIUM");
    printf("\n\t\t > Press N for SPORTS QUIZ DIFFICULT");
    printf("\n\t\t > Press Q for ENTERTAINMENT QUIZ EASY ");
    printf("\n\t\t > Press T for ENTERTAINMENT QUIZ MEDIUM ");
    printf("\n\t\t > Press F for ENTERTAINMENT QUIZ DIFFICULT ");
...
void e1_quiz(){
 ...
 score:
    ...
    {
        printf("\n\n\n \t\t****** CONGRATULATION ******");
        printf("\n\t\t\t\t YOU HAVE OUT OFF SCORE");
        printf("\t\t Thank You!!");
    }
     else
    {
     printf("\n\n\t**** SORRY YOU HAVE 0 SCORE****");
...
void e2_quiz(){
 ...
 switch(r)
    {
    case 1:
    printf("\n\n`Lungi Dance` song is featured in ____\n");
 ...
 case 3:
    ...
    {printf("\n\nWrong!!! The correct answer is C.Threat Analysis & Surveillence Cell");getch();
    break;}
...
void e3_quiz(){
 ...
 case 3:
    printf("\n\n\nNumber of players in a football team are? \n");
    printf("\n\nA.11\t\tB.9\n\nC.10\t\tD.15\n");
    if (toupper(getch())=='A')
    {printf("\n\nCorrect!!!");countr++;getch();
    break;}
    else
    {printf("\n\nWrong!!! The correct answer is A.11");getch();
    break;}
